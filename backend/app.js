...
app.post("/analysis", (request, response, next) => {
    ...
    const creation_date=request.body.creation_date
    const url=request.body.url
    const automatic_keywords=request.body.automatic_keywords
    const manual_keywords=request.body.manual_keywords
    const analysis_results=request.body.analysis_results
...
app.listen(PORT, () =>{
    console.log("Attente des requêtes au port " + PORT);  // const PORT = 3000 (ligne1)
})
